...
import { ImageCache } from '../js/media/image_cache.js';

const sourceFiles = await Promise.all([
  readFile(new URL('../src/media/image_cache.ts', import.meta.url), 'utf8'),
...
test('layer persistence uses one image cache contract', () => {
  ...
  assert.match(canvasSource, /from "\.\.\/media\/image_cache\.js"/);

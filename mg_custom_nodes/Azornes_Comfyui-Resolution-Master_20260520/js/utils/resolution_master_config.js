...
export const tooltips = {
    ...
    latValueArea: "Choose the latent format for your model. Use 4x8 for most SD/SDXL/Flux workflows, or 128x16 for Flux.2.",
    
    // Scaling controls (buttons and dropdowns only)
    scaleBtn: "Apply manual scaling factor",
    upscaleRadio: "Use the manual scale value for the Rescale Factor output.",
    ...
    megapixelsRadio: "Use the selected megapixel target for the Rescale Factor output.",
    megapixelsValueArea: "Click to set custom megapixel value (e.g., 3.5MP)",
    preserveScalingRatioCheckbox: "Keep the current aspect ratio when scaling. The final size may shift slightly to stay proportional.",
    
    // Auto-detect controls
    autoDetectToggle: "Automatically detect resolution from connected image input",
    autoFitBtn: "Match the current size to the closest preset.",
    autoFitCheckbox: "When a new image is detected, automatically match it to the closest preset.",
    autoResizeBtn: "Resize using the selected scaling mode.",
    autoResizeCheckbox: "When a new image is detected, automatically resize it using the selected scaling mode.",
    autoSnapBtn: "Snap current resolution to the nearest snap value",
    autoSnapCheckbox: "After auto-resize, round the size to the selected snap value.",
    ...
    customCalcCheckbox: "When a new image is detected, apply the selected model's recommended size rules.",
    autoCalcBtn: "Apply the selected model's recommended size rules to the current size.",

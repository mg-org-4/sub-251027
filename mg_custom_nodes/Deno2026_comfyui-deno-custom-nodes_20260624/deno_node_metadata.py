...
NODE_INPUT_TOOLTIPS = {
    ...
    "DenoLTXTiledSpatialUpscaler": {
        ...
        "horizontal_tiles": "Number of spatial tiles across latent width.",
        "vertical_tiles": "Number of spatial tiles across latent height. Start with 2 for tall portrait videos.",
        ...
        "aggressive_memory_cleanup": "Run extra cleanup between tiles. Slower, but can help fragmented VRAM.",
        "debug": "Print tile plan and shape diagnostics to the ComfyUI console.",
    },
    "DenoLTXStepFusedTiledSampler": {
        "noise": "Noise source used once for the global sampler trajectory.",
        "guider": "BasicGuider or CFGGuider for the LTX second pass.",
        "sampler": "ComfyUI sampler object. The node keeps the sampler update global.",
        "sigmas": "Sigma schedule for the low-denoise second-pass refinement.",
        "latent_image": "Video-only LTX latent to refine. AV combined latents should be separated before this node.",
        "horizontal_tiles": "Number of spatial tiles across latent width.",
        "vertical_tiles": "Number of spatial tiles across latent height. Start with 2 for tall portrait videos.",
        "overlap": "Overlap in latent tokens for each model-prediction tile.",
        "blend_mode": "Overlap weighting curve. Hann is the recommended starting point.",
        "aggressive_memory_cleanup": "Run extra cleanup between tile predictions. Slower, but can help fragmented VRAM.",
        "debug": "Print hook calls, sigma labels, and tile diagnostics to the ComfyUI console.",
    },
...
NODE_OUTPUT_TOOLTIPS = {
    ...
    "DenoLTXStepFusedTiledSampler": (
        "Refined video latent from one global sampler trajectory.",
        "Denoised output latent from the same global sampler trajectory.",
    ),
    "DenoBerniniPromptGuide": (

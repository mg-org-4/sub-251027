...
_OPTIONAL_NODES = (
    ...
    ("deno_ltx_tiled_nodes", "DenoLTXTiledSpatialUpscaler", "(Deno) LTX Tiled Spatial Upscaler"),
    ("deno_ltx_tiled_nodes", "DenoLTXAVStepFusedTiledSampler", "(Deno) LTX High resolution Tiled Sampler"),

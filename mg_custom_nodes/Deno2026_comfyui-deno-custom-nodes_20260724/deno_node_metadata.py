...
NODE_INPUT_TOOLTIPS = {
    ...
    "DenoLocalLLMRefiner": {
        "provider": "Choose the local provider to call: Ollama, LM Studio, llama.cpp, vLLM, or Custom.",
        ...
        "custom_server_url": "Local OpenAI-compatible server URL used by llama.cpp, vLLM, or Custom.",

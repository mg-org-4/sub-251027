...
NODE_INPUT_TOOLTIPS = {
    ...
    "DenoLocalLLMRefiner": {
        "provider": "Choose the local provider to call: Ollama, LM Studio, llama.cpp, vLLM, Custom, or llama-swap.",
        ...
        "custom_server_url": "Local OpenAI-compatible server URL used by llama.cpp, vLLM, Custom, or llama-swap.",
        ...
        "keep_minutes": "How many minutes to keep the local model loaded when Keep for minutes is selected. llama-swap uses its own server-side unload timeout.",

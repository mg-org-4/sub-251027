"""
Group convolution and feature fusion modules for MatAnyone2.
"""
...
def interpolate_groups(
    ...
    """Interpolates group tensor by ratio."""
...
def downsample_groups(
    ...
    """Downsamples group tensor."""
    return interpolate_groups(g, ratio, mode, align_corners)


class GConv2d(nn.Conv2d):
    """Group convolution (batch, num_objects, C, H, W)."""
...
class GroupResBlock(nn.Module):
    """Residual block for group tensors."""
...
class MainToGroupDistributor(nn.Module):
    """Distributes main features to group dimension."""

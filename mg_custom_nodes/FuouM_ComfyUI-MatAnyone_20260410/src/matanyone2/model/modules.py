"""
Decoder and sensory updater modules for MatAnyone2.
"""
...
class MaskUpsampleBlock(nn.Module):
    """Mask upsample block with group features."""
...
class DecoderFeatureProcessor(nn.Module):
    """Processes multi-scale decoder features."""
...
class SensoryUpdater_fullscale(nn.Module):
    """Full-scale sensory updater for decoder."""
...
class SensoryUpdater(nn.Module):
    """Sensory updater for decoder (reduced scale)."""

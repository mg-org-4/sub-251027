"""
Object manager for MatAnyone2 inference.
"""
...
class ObjectManager:
    """
    Manages object IDs and temporary IDs.
    Object IDs are immutable; temporary IDs indicate tensor positions.
    """
    ...
    def add_new_objects(
        self,
        objects: Union[List[ObjectInfo], ObjectInfo, List[int]],
    ) -> tuple:
    ...
    def purge_inactive_objects(self, max_missed_detection_count: int) -> tuple:
    ...
    def has_all(self, objects: List[int]) -> bool:
        for obj in objects:
            if obj not in self.obj_id_to_obj:
                return False
        return True

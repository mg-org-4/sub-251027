...
from .iamccs_cine_h3_vision_info import (
    ...
    NODE_DISPLAY_NAME_MAPPINGS as IAMCCS_CINE_H3_VISION_NODE_DISPLAY_NAME_MAPPINGS,
)
...
from .iamccs_influencer_sampler import (
    IAMCCSInfluencerSampler,
    IAMCCSInfluencerLatent,
)
...
try:
    from .iamccs_wananimate2_extends import (
        IAMCCS_WanAnimate2Extends,
        IAMCCS_WanAnimate2ExtendPlan,
    )
except Exception as exc:
    logging.warning("IAMCCS Wan-Animate-2 Extends nodes unavailable: %s", exc)
    IAMCCS_WanAnimate2Extends = None
    IAMCCS_WanAnimate2ExtendPlan = None

try:
    from .v2v_shotboard_easy_wananimate2 import IAMCCS_WanAnimate2ShotboardBridge
except Exception as exc:
    logging.warning("IAMCCS Wan-Animate-2 Shotboard bridge unavailable: %s", exc)
    IAMCCS_WanAnimate2ShotboardBridge = None
...
NODE_CLASS_MAPPINGS = {
    ...
    **({
    ...
    } if IAMCCS_WanAnimate2Extends is not None else {}),

    **({
        "IAMCCS_WanAnimate2ShotboardBridge": IAMCCS_WanAnimate2ShotboardBridge,
    } if IAMCCS_WanAnimate2ShotboardBridge is not None else {}),
...
try:
    from .v2v_shotboard_easy_wananimate2 import (
        NODE_CLASS_MAPPINGS as _IAMCCS_V2V_SHOTBOARD_EASY_WANANIMATE2_NODE_CLASS_MAPPINGS,
        NODE_DISPLAY_NAME_MAPPINGS as _IAMCCS_V2V_SHOTBOARD_EASY_WANANIMATE2_NODE_DISPLAY_NAME_MAPPINGS,
    )
    NODE_CLASS_MAPPINGS.update(_IAMCCS_V2V_SHOTBOARD_EASY_WANANIMATE2_NODE_CLASS_MAPPINGS)
    NODE_DISPLAY_NAME_MAPPINGS.update(_IAMCCS_V2V_SHOTBOARD_EASY_WANANIMATE2_NODE_DISPLAY_NAME_MAPPINGS)
except Exception as _iamccs_v2v_shotboard_easy_wananimate2_error:
    print(
        "[IAMCCS V2V Shotboard Easy WanAnimate2] optional module not loaded: "
        f"{_iamccs_v2v_shotboard_easy_wananimate2_error}"
    )
...
# Shotboard V4 retake R2 is deliberately isolated from the legacy V4 backend.
# If its optional module is absent, every existing V3/V4 node keeps loading.
try:
    from .iamccs_cine_shotboard_v4_retake_r2 import (
        NODE_CLASS_MAPPINGS as _IAMCCS_SHOTBOARD_V4_RETAKE_R2_NODE_CLASS_MAPPINGS,
        NODE_DISPLAY_NAME_MAPPINGS as _IAMCCS_SHOTBOARD_V4_RETAKE_R2_NODE_DISPLAY_NAME_MAPPINGS,
    )
    NODE_CLASS_MAPPINGS.update(_IAMCCS_SHOTBOARD_V4_RETAKE_R2_NODE_CLASS_MAPPINGS)

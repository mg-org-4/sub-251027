...
class IAMCCS_MiniMaxH3AtomicConditioningBackend:
    ...
    def prepare(
        ...
        filmlab_enabled = isinstance(filmlab_context, dict) and bool(filmlab_context.get("enabled"))
        filmlab_active = filmlab_is_continuity_active(filmlab_context, segment_index)
        # By Carmine Cristallo Scalzi AI research (IAMCCS) - patreon.com/IAMCCS - carminecristalloscalzi.com
        LOG.warning(
        ...
        motion_state = {
            ...
            "method": "filmlab_av_latent_pin" if filmlab_enabled else "planned_fl2va_keyframes",
        ...
        del bridge_frame, motion_context
        ...
        if task == "t2va":
            ...
            if (last is None or first is None) and not filmlab_active:
            ...
            if filmlab_active:
                manifest.append({"label": "AV latent tail", "role": "full_chunk_continuation"})
            else:
                manifest.extend([

    ...
    def INPUT_TYPES(cls):
        return {
            ...
            "optional": {
                ...
                "render_id": ("STRING", {"default": "minimax_h3_render"}),
                # Multi-chunk FLF must finish its native master before the
                # delivery branch runs. Default to the built-in queue when a
                # workflow payload omits this optional widget.

...
const HELP = {
    ...
    longvid_continuous_guided: ["Place at least two image guides in chronological order; every image is a destination inside the same evolving take.", "N images compile to N−1 FL2VA intervals. The first interval uses its authored opening and destination; later intervals open from the previous sampled native AV latent.", "Describe continuous action and camera evolution between each adjacent pair. Do not write hard-cut or new-shot language unless you intend the model to fight the continuity contract.", "Use a 22-frame tail first. Each interval, including its hidden context prefix, must remain within MiniMax H3's 362-frame limit.", "Choose H3 Generated Audio for an evolving native soundtrack, or align AudioBoard clips and select Audio Drive when exact timing is required."],
...
export function createModeHelper(mode) {
    ...
    for (const [key,label] of Object.entries({t2va:"T2VA",i2va:"I2VA",fl2va:"FL2VA",ref2va:"REF2VA / LipSync",longvid_guides:"LongVid positioned guides",multi_shot_lipsync:"Long Multi-Shot",longvid_continuous_guided:"Long Continuous Guided",audio_driven:"Audio Driven",v2va_object_swap:"V2VA"})) helpSelect.append(new Option(label,key));

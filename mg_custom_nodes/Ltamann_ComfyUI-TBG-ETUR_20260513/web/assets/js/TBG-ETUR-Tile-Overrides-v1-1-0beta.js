...
if (!window.TBG.TBGETUR) {
    window.TBG.TBGETUR = {
        ...
        // Per-node stores
        messages: {},   // node.id â†’ {prompts, tiles, denoises, seeds, cnet_strength}
        inputs:   {},   // node.id â†’ {prompts, tiles, denoises, seeds, cnet_strength}
    ...
    async beforeRegisterNodeDef(nodeType, nodeData, app) {
        ...
        if (isTileOverridesNode) {
            ...
            // CRITICAL: Persist data now that we have tiles and UI is populated
                const hasContent = [...msg.prompts, ...msg.denoises, ...msg.seeds, ...msg.cnet_strength]
                  .some(v => v !== null && v !== "");

import { E as g, w as E, e as l } from "./entry-GsSiDCM7.js";
let p = !1, i = null, u = null, c = null, d = null, w = null, v = 0, _ = 0;
...
function y(e) {
  ...
  if (n === "image" || n === "video" || n === "audio" || n === "model3d")
    return !0;
  const t = T((e == null ? void 0 : e.filename) || (e == null ? void 0 : e.name) || "");
  ...
  try {
    ...
    d = o, c = (a) => {
      ...
      try {
        ...
        (s = console.debug) == null || s.call(console, "[MFV] b_preview_with_metadata error", r);
      }
      ...
      try {
        ...
        (s = console.debug) == null || s.call(console, "[MFV] preview blob error", r);
      }
...
function h() {
  ...
  if (d) {
    ...
    if (c)
      try {
        d.removeEventListener("b_preview_with_metadata", c);
      } catch (t) {
        (n = console.debug) == null || n.call(console, t);
      }
  }
  u = null, c = null, _ = 0, d = null;
}
function O(e) {
  w = e || null;
}

import { _ as e, i as t, r as n, v as r, y as i } from "./config-VsGZ1HHP.js";
//#region js/app/settingsStore.js
...
//#endregion
//#region js/app/comfyApiBridge.js
var S = null, ce = null, le = 50;
function C(e) {
...
function T(e) {
	return C(e) ? typeof e.fetchApi == "function" || typeof e.apiURL == "function" || C(e.settings) : !1;
}
function E(e) {
	return C(e) ? C(e.ui) || C(e.canvas) || C(e.graph) || typeof e.loadGraphData == "function" || T(e.api) : !1;
}
function ue(e) {
	return E(e) && (S = e), S;
}
...
function D(e) {
	if (T(ce)) return ce;
	let t = C(e) ? e : O(), n = t?.api || t?.ui?.api || t?.ui?.app?.api || null;
	if (T(n)) return n;
	try {
		let e = typeof window < "u" ? w(window, "api") : null;
		if (T(e)) return e;
	} catch (e) {
		console.debug?.(e);
	}
	try {
		let e = typeof globalThis < "u" ? w(globalThis, "api") : null;
		if (T(e)) return e;
	} catch (e) {
		console.debug?.(e);
	}
...
function O() {
	if (E(S)) return S;
	try {
		let e = typeof globalThis < "u" ? w(globalThis, "app") : null;
		if (E(e)) return e;
	} catch (e) {
		console.debug?.(e);
	}
	try {
		let e = typeof window < "u" ? w(window, "app") : null;
		if (E(e)) return e;
	} catch (e) {
		console.debug?.(e);
	}
...
function he(e) {
	let t = k(e);
	return C(t) && (t?.sidebarTabStore || t?.sidebarTab || t?.workspaceStore?.sidebarTab) || null;
}
function ge(e) {
...
function ve(e, t) {
	let n = C(e) ? e : O(), r = k(n), i = he(n), a = String(t || "").trim();
	if (!r || !a) return !1;
	let o = [
		"activateSidebarTab",
		"openSidebarTab",
...
function xe(e, t) {
	try {
		let n = C(e) ? e : O(), r = n?.extensionManager || n?.ui?.extensionManager || null, i = he(n);
...
async function we({ timeoutMs: e = 4e3, intervalMs: t = le, warnOnTimeout: n = !0, rejectOnTimeout: r = !1 } = {}) {
...
async function Te({ app: e = null, timeoutMs: t = 4e3, intervalMs: n = le, warnOnTimeout: r = !0, rejectOnTimeout: i = !1 } = {}) {
...
//#endregion
//#region js/app/settings/SettingsStore.js
var A = /* @__PURE__ */ new Map(), Ee = !1, j = null;
function De() {
	try {
...
function ke() {
	if (!Ee) try {
		...
		}, window.addEventListener("storage", j), Ee = !0;
	} catch (e) {
		console.debug?.(e);
	}
}
var M = {
	...
	dispose() {
		try {
			Ee && j && typeof window < "u" && window.removeEventListener("storage", j);
		} catch (e) {
			console.debug?.(e);
		}
		Ee = !1, j = null, A.clear();
...
function Be() {
	return R ? Promise.resolve() : (Le ||= import("./i18n.generated-DB0ZXt-J.js").then(({ GENERATED_TRANSLATIONS: e }) => {
		Re(e);
	}).catch((e) => {
...
function st(t, n = "info", r = null) {
	...
	if (!o) return null;
	let s = it(t.durationMs ?? t.duration ?? r), c = Number(t.createdAt), l = Number.isFinite(c) && c > 0 ? c : Date.now(), u = typeof t.persistent == "boolean" ? t.persistent : !(Number.isFinite(s) && s > 0);
	return {
		id: U(t.id) || e(`th-${l}-`, 4),
		message: o,
		title: i,
...
function ft(e, t, n) {
	...
	if (!r || !r.forceStore && !r.trackId && r.type === "info" && Number.isFinite(r.durationMs) && r.durationMs > 0 && r.durationMs < 2500) return;
...
function yt(e, t, n, r) {
	let i = r?.history && typeof r.history == "object" ? r.history : null, a = {
		type: t,
		durationMs: Number.isFinite(Number(n)) ? Number(n) : null,
...
async function Ln(e, t) {
	...
	if (e && typeof e == "object") {
		...
		if (a?.ok && n) try {
			let e = await getAssetMetadata(n);
			e?.ok && e?.data && (a.data = {
				...a.data || {},
				asset: e.data
			});
...
//#endregion
export { An as $, Mn as A, mt as At, on as B, M as Bt, zn as C, Jn as Ct, Dn as D, bt as Dt, Bn as E, Ct as Et, qt as F, Je as Ft, Zn as G, de as Gt, Yt as H, O as Ht, un as I, Ye as It, Nn as J, Te as Jt, Rn as K, ue as Kt, rn as L, B as Lt, $t as M, ht as Mt, fn as N, Ze as Nt, tn as O, nt as Ot, cn as P, Qe as Pt, yn as Q, a as Qt, En as R, Xe as Rt, vn as S, Wn as St, Fn as T, Lt as Tt, Cn as U, _e as Ut, Tn as V, D as Vt, xn as W, ge as Wt, Hn as X, x as Xt, _n as Y, we as Yt, Ln as Z, o as Zt, Q as _, Yn as _t, Nr as a, ln as at, Vn as b, Kn as bt, kr as c, Kt as ct, wr as d, sn as dt, kn as et, Er as f, Xt as ft, Tr as g, wn as gt, Or as h, Sn as ht, Pr as i, pn as it, Zt as j, pt as jt, Un as k, gt as kt, Fr as l, an as lt, Dr as m, jn as mt, zr as n, Qt as nt, jr as o, Jt as ot, Cr as p, bn as pt, On as q, me as qt, Br as r, en as rt, Mr as s, dn as st, Ar as t, nn as tt, Z as u, hn as ut, xr as v, Gn as vt, Pn as w, Qn as wt, gn as x, qn as xt, Sr as y, Xn as yt, mn as z, V as zt };

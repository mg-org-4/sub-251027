import { Ht as e, a as t, i as n, l as r, zt as i } from "./hostAdapter-B599OfQC.js";
import { t as a } from "./config-VsGZ1HHP.js";
import { B as o, S as s, b as c, g as l, x as u } from "./SidebarWorkflowSection-BA90WRcr.js";
import { n as d, t as f } from "./state-B8eTxorm.js";
//#region js/features/viewer/floatingViewerProgress.js
...
function T(e, t) {
	...
	if (!n) return !1;
	try {
		let e = getComfyApp(), t = e?.graph || null, r = e?.canvas || null, i = t?.getNodeById?.(Number(n)) || null;
		return !i || typeof r?.centerOnNode != "function" ? !1 : (r.centerOnNode(i), !0);
	} catch (e) {
...
function te(e) {
	...
	return a.className = "mjr-mfv-progress-text", a.textContent = "Idle", t.appendChild(n), t.appendChild(r), t.appendChild(i), t.appendChild(a), t.addEventListener("pointerdown", (t) => {
		t.button === 0 && T(e, e._progressCurrentNodeId) && (t.preventDefault(), t.stopPropagation());
...
function ne(e) {
	...
	return n.className = "mjr-mfv-media-progress-text", t.appendChild(n), e._mediaProgressEl = t, e._mediaProgressTextEl = n, w(e, b.getSnapshot()), t;
}
function re(e) {
...
//#endregion
//#region js/components/VideoControls.js
var ie = 400, ae = 1e3, oe = 220;
function se(e, t, n) {
	try {
...
function D(e, t = {}) {
	try {
		...
		v.className = "mjr-video-range mjr-video-range--seek", v.type = "range", v.min = "0", v.max = String(ae), v.step = "1", v.value = "0", v.setAttribute("aria-label", i("video.seek", "Seek")), v.title = r ? i("video.seekThroughAudio", "Seek through audio") : i("video.seekThrough", "Seek through video");
		...
		E.className = "mjr-video-seek-playhead-label", y.appendChild(w), y.appendChild(T), y.appendChild(re), y.appendChild(E);
		...
		he.className = "mjr-video-seek-handle mjr-video-seek-handle--out", he.title = i("video.dragSetOut", "Drag to set Out"), he.setAttribute("aria-label", i("video.dragSetOut", "Drag to set Out")), _.appendChild(v), b && _.appendChild(b), _.appendChild(y), _.appendChild(te), _.appendChild(ne), _.appendChild(D), _.appendChild(he);
		...
		let ve = le("mjr-video-btn--play", i("btn.play", "Play"), i("video.playPauseSpace", "Play/Pause (Space)")), ye = le("mjr-video-btn--step", "<", i("video.stepBack", "Step back")), be = le("mjr-video-btn--step", ">", i("video.stepForward", "Step forward")), xe = le("mjr-video-btn--jump mjr-video-btn--in", "|<", i("video.goToIn", "Go to In")), Se = le("mjr-video-btn--jump mjr-video-btn--out", ">|", i("video.goToOut", "Go to Out")), Ce = le("mjr-video-btn--mark mjr-video-btn--in", "I", i("video.setInFromCurrent", "Set In from current frame")), A = le("mjr-video-btn--mark mjr-video-btn--out", "O", i("video.setOutFromCurrent", "Set Out from current frame")), we = ue("mjr-video-btn--toggle", "pi-refresh", i("video.loopPlaybackInRange", "Loop playback in range"), i("video.loop", "Loop")), j = we.btn, Te = de("mjr-video-num--in", {
			min: 0,
			step: 1,
			value: 0,
		...
		let Ve = (e, t) => {
			...
			try {
				...
				if (ge.textContent = `${ce(i)} / ${a ? ce(n) : "0:00"}`, v.disabled = !a, a) {
				...
				if (o) {
					...
					try {
						if (Number.isFinite(n) && n > 0) {
							let e = d((i || 0) / n);
							E.style.left = `${e * 100}%`, E.textContent = String(t), E.style.display = "";
			...
			if (o) try {
				...
				try {
					let e = Math.max(1, Math.floor(n / ie)), t = Math.max(e, Math.floor(Number(U.step) || 1)), r = t / n * 100, i = r * 10;
		...
		let nt = (t) => {
			try {
				...
				return e.currentTime = o, v.value = String(Math.round(a * ae)), J(o), !0;
			} catch (e) {
				return console.debug?.(e), !1;
			}
		}, Q = {
		...
		if (o) {
			...
			H.push(u(D, "pointerdown", (e) => n(e, "in"), { passive: !1 })), H.push(u(he, "pointerdown", (e) => n(e, "out"), { passive: !1 })), H.push(u(te, "pointerdown", (e) => n(e, "in"), { passive: !1 })), H.push(u(ne, "pointerdown", (e) => n(e, "out"), { passive: !1 })), H.push(u(_, "pointermove", r, { passive: !1 })), H.push(u(_, "pointerup", i, { passive: !1 })), H.push(u(_, "pointercancel", i, { passive: !1 }));
		}
...
//#endregion
//#region js/features/viewer/mediaPlayer.js
function he(e) {
...
//#endregion
//#region js/utils/tooltipShortcuts.js
function k(e, t) {
...
//#endregion
//#region js/features/viewer/videoSync.js
var ye = () => {
	try {
...
//#endregion
//#region js/app/settings/MajoorSettingsDialog.js
...
//#endregion
//#region js/app/openMajoorSettings.js
function R(t = e()) {
	return je(t);
}
try {
...
//#endregion
export { b as _, be as a, ge as c, O as d, D as f, x as g, re as h, Se as i, he as l, te as m, Ce as n, k as o, ne as p, xe as r, ve as s, R as t, _e as u };

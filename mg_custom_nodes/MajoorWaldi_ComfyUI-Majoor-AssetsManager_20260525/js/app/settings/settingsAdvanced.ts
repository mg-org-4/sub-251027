...
export function registerAdvancedSettings(safeAddSetting: (def: any) => void, settings: Record<string, any>, notifyApplied: (..._args: any[]) => void, app?: any | null): void {
    ...
    let _outputDirSaveAbort: any = null;
    ...
    let _indexDirSaveAbort: any = null;
...

    {
        ...
        let _hfTokenSaveTimer: any = null;
        ...
        const _applyHfTokenVisibility = () => {
            try {
                const inputs = Array.from(
                    document.querySelectorAll<HTMLInputElement>('input[data-mjr-hf-token="1"]'),
                );
        ...
        const _applyHfTokenPlaceholder = (placeholderText: any) => {
            try {

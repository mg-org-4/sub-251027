 ...
 */
export function createMjrApp(rootComponent: any, props: Record<string, any> | undefined = undefined): { app: ReturnType<typeof createApp>; pinia: ReturnType<typeof createPinia> } {
...
function _dispatchKeepAliveAttached(mountKey: any, host: any, container: any) {
    try {
...
function _createHost(mountKey: any) {
...
function _attachHost(container: any, host: any) {

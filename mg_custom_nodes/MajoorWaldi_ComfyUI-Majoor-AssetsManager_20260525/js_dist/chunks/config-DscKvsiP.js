...
function s(t) {
	try {
		if (!t) return "";
		let n = t, r = n.file_info;
		return e(n.root_id ?? n.rootId ?? n.custom_root_id ?? n.customRootId ?? n.customRoot ?? r?.root_id ?? r?.rootId ?? "");
	} catch {
		return "";
	}
}
//#endregion
//#region js/utils/path.ts
function c(e) {

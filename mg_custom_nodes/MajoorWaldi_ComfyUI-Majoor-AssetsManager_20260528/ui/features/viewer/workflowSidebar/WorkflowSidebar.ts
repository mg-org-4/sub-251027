...
type SidebarMode = "nodes" | "graph";

interface WorkflowSidebarOptions {
    hostEl?: HTMLElement | null;
    onClose?: () => void;
    onOpenGraphMap?: () => void;
    onCloseGraphMap?: () => void;
}
...
export class WorkflowSidebar {
    ...
    _onClose: (() => void) | null;
    _onOpenGraphMap: (() => void) | null;
    _onCloseGraphMap: (() => void) | null;
    _visible: boolean;
    _liveSyncHandle: number | null;
    _liveSyncMode: "" | "raf" | "timeout";
    _lastLiveSyncAt: number;
    _resizeCleanup: (() => void) | null;
    _nodesTab: WorkflowNodesTab | null;
    _graphMapPanel: WorkflowGraphMapPanel | null;
    _activeMode: SidebarMode;
    _asset: unknown;
    _el: HTMLElement;
    _body: HTMLDivElement | null;
    _nodesModeBtn: HTMLButtonElement | null;
    _graphModeBtn: HTMLButtonElement | null;

    constructor({ hostEl, onClose, onOpenGraphMap, onCloseGraphMap }: WorkflowSidebarOptions = {}) {
        this._hostEl = hostEl;
        ...
        this._asset = null;
        this._body = null;
        this._nodesModeBtn = null;
        this._graphModeBtn = null;
    ...
    _makeModeButton(label: string, iconClass: string, mode: SidebarMode): HTMLButtonElement {
    ...
    _bindResize(handle: HTMLElement | null) {
        if (!handle) return;
...
function _getFrameHost(el: HTMLElement | null | undefined): Window & typeof globalThis {
...
function _getFrameTimestamp(el: HTMLElement | null | undefined): number {

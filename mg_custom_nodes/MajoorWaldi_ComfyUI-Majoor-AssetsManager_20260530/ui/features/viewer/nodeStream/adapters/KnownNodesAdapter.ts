...
export const KnownNodesAdapter = createAdapter({
    ...
    canHandle(classType: any, outputs: any) {
    ...
    extractMedia(classType: any, outputs: any, nodeId: any) {
        const images = outputs?.images;
 ...
 */
export function isKnownProcessingNode(classType: string): boolean {
 ...
 */
export function isKnownOutputNode(classType: string): boolean {
 ...
 */
export function getKnownNodeSets(): Record<string, any> {
    return {

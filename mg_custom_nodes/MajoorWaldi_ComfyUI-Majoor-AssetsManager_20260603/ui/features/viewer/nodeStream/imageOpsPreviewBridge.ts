 ...
 */
function _computeContentRect(st: any, canvas: any) {
...
function _signatureFor(node: any, st: any, canvas: any, crop: any) {
...
function _encodeCropped(canvas: any, crop: any) {
...
export function extractImageOpsPreview(node: any): any {
    if (!node) return null;
...
export function hasImageOpsPreviewState(node: any): boolean {

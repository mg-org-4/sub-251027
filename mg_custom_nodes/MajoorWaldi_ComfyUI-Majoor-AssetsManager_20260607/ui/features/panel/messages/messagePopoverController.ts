...
function resolveMessageText(entry: any, keyField: any, fallbackField: any, fallbackText: any) {
...
function normalizeMessageLevel(value: any) {
...
function resolveSafeActionUrl(value: any) {
...
function resolveMessageEmoji(entry: any) {
...
function formatHistoryDuration(entry: any) {
...
function formatHistoryStatus(status: any) {
...
function formatHistoryProgressSummary(entry: any) {
...
function getHistoryProgressPercent(entry: any) {
    const progress = entry?.progress;
...
export function bindMessagePopoverController({
    ...
    const setCountBadge = (node: any, count: any) => {
        if (!node) return;
    ...
    const showTabByName = (tabName: any) => {
        if (tabName === "messages") {
            showMessagesTab();
            return;
        }
    ...
    const onTabKeydown = (event: any, tabName: any) => {
    ...
    messageTabBtn?.addEventListener("keydown", (e: any) => onTabKeydown(e, "messages"), listenerOptions);
    ...
    historyTabBtn?.addEventListener("keydown", (e: any) => onTabKeydown(e, "history"), listenerOptions);
    ...
    shortcutsTabBtn?.addEventListener(
        "keydown",
        (e: any) => onTabKeydown(e, "shortcuts"),
        listenerOptions,
    );

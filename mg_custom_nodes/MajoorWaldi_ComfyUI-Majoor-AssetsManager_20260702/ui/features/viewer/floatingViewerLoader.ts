...
function _isImageOpsLive(fileData: any) {
    return String(fileData?._source || "") === IMAGEOPS_LIVE_SOURCE;
}

export function loadFloatingViewerMediaA(viewer: any, fileData: any, { autoMode = false }: { autoMode?: boolean } = {}): void {

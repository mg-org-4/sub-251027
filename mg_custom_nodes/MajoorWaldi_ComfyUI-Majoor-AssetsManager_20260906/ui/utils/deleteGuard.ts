...
export async function confirmDeletion(count: number, label?: string): Promise<boolean> {
    ...
    return Boolean(
        await comfyConfirm(message, t("dialog.confirmDeleteTitle", "Majoor: Confirm delete")),
    );
}

...
The H3 storyboard / loop pipeline has four units, named from the upstream
[`ComfyUI-MiniMaxH3-Context-Loop`](https://github.com/ethanfel/ComfyUI-MiniMaxH3-Context-Loop)
project (`docs/README.md` + `H3_CHAIN_FORMAT_GUIDE.md`).

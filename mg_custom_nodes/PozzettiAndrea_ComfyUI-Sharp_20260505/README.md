...
1. **ComfyUI Manager (nightly, recommended)** — search for `ComfyUI-Sharp` in the Manager and click Install **from the nightly version**. Do **NOT** use any numbered version like `0.2.4` — they are outdated.

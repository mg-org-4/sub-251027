            ...
            "required": {
                ...
                "preset_standard": (
                    [
                        ...
                        "Portrait - 480x640 (3:4)", "Portrait - 512x768 (3:2)", "Portrait - 768x1024 (3:4)",
                        ...
                        "Portrait - 1080x1920 (9:16)", "Portrait - 816x1920 (21:9)",
                        ...
                        "Landscape - 1920x1080 (16:9)", "Landscape - 1920x1024 (15:8)", "Landscape - 1920x816 (20:9)",
                    ],
    ...
    def generate(self, vae, size_mode, active_preset, preset_standard, preset_qwen, preset_krea2, width, height, megapixels, aspect_ratio, batch_size):
        ...
        if size_mode == "Preset":
            ...
            size_map = {
                ...
                "Portrait - 480x640 (3:4)": (480, 640), "Portrait - 512x768 (3:2)": (512, 768),
                ...
                "Landscape - 1920x1024 (15:8)": (1920, 1024), "Landscape - 1920x816 (20:9)": (1920, 816),
                # Qwen

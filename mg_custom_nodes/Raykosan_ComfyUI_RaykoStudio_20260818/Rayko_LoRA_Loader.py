...
class RaykoLoRALoader:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "use_clip": ("BOOLEAN", {"default": True, "label": "Apply LoRA to CLIP"}),
    ...
    DESCRIPTION = "Applies multiple LoRA models to the input model and optionally to CLIP."
                ...
                if lora_full_path:
                    try:
                        if use_clip and clip is not None:
                            ...
                            model, _ = lora_loader.load_lora(model, None, lora_relative_path, strength_model, strength_clip)

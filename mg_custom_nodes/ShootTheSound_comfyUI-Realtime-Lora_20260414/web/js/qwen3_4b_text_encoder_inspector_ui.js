...
// ============================================================================
// QWEN3-4B TEXT ENCODER INSPECTOR — Visual Analysis UI
// ============================================================================

app.registerExtension({
    name: "Qwen3_4BTextEncoderInspector.VisualReport",

    async beforeRegisterNodeDef(nodeType, nodeData, app) {
        if (nodeData.name !== "Qwen3_4BTextEncoderInspector") return;
        ...
        nodeType.prototype.onDrawForeground = function(ctx) {
            ...
            ctx.fillText("Qwen3-4B Layer Activation Analysis", 10, startY + 15);

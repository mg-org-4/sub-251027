// Dynamic input handler for Star Image Loop
// Adds/removes image inputs as needed for joining multiple panoramas
import { app } from "../../../../scripts/app.js";

function updateImageInputs(node) {
    console.log("[StarImageLoopDynamic] updateInputs called", node?.title || node?.type);
    ...
    try {
        ...
        console.error("[StarImageLoopDynamic] Error in updateInputs:", e);
    } finally {
...
app.registerExtension({
    name: "StarImageLoopDynamic",
    beforeRegisterNodeDef(nodeType, nodeData, app) {
        if (nodeData.name !== "StarImageLoop") return;
        console.log("[StarImageLoopDynamic] beforeRegisterNodeDef for", nodeData.name);

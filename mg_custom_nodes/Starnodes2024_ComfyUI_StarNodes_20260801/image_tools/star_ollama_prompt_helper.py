...
try:
    ...
    print("[StarOllamaPromptHelper] Warning: 'ollama' not installed. Install with: pip install ollama")
    Client = None
...
if OLLAMA_AVAILABLE and SERVER_AVAILABLE:
    ...
    print("[StarOllamaPromptHelper] Node not registered due to missing dependencies. Install with: pip install ollama")
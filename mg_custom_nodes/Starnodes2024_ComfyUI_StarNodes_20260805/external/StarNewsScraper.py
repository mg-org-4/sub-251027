try:
    ...
    print("[StarNewsScraper] Warning: 'requests' not installed. Install with: pip install requests")
...
try:
    ...
    BS4_AVAILABLE = False
    print("[StarNewsScraper] Warning: 'beautifulsoup4' not installed. Install with: pip install beautifulsoup4")
...
if REQUESTS_AVAILABLE and BS4_AVAILABLE:
    ...
    print("[StarNewsScraper] Node not registered due to missing dependencies. Install with: pip install requests beautifulsoup4")

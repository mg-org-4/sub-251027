...
try:
    ...
    print("[StarPSDSaver2] Warning: 'psd-tools' not installed. Install with: pip install psd-tools")
...
if PSD_TOOLS_AVAILABLE:
    ...
    print("[StarPSDSaver2] Node not registered due to missing dependency: psd-tools. Install with: pip install psd-tools")

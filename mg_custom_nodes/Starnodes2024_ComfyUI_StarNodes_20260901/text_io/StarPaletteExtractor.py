...
try:
    ...
    print("[StarPaletteExtractor] Warning: 'webcolors' not installed. Install with: pip install webcolors")
...
try:
    ...
    print("[StarPaletteExtractor] Warning: 'scikit-learn' not installed. Install with: pip install scikit-learn")
...
if WEBCOLORS_AVAILABLE and SKLEARN_AVAILABLE:
    ...
    print("[StarPaletteExtractor] Node not registered due to missing dependencies. Install with: pip install webcolors scikit-learn")
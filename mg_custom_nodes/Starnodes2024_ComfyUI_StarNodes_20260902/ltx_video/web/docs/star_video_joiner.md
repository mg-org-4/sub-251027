...
The **Star Video Joiner** node allows you to combine multiple image batches and audio inputs into a single unified output. This is particularly useful for preparing content for video creation nodes.

...
try:
    ...
    print("[StarPSDSaver] Warning: 'psd-tools' not installed. Install with: pip install psd-tools")
...
if PSD_TOOLS_AVAILABLE:
    NODE_CLASS_MAPPINGS["StarPSDSaver"] = StarPSDSaver
    NODE_DISPLAY_NAME_MAPPINGS["StarPSDSaver"] = "⭐ Star PSD Saver (Dynamic)"
else:
    print("[StarPSDSaver] Node not registered due to missing dependency: psd-tools. Install with: pip install psd-tools")

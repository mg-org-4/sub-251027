...
try:
    ...
    print("[StarPSDSaverAdvLayers] Warning: 'psd-tools' not installed. Install with: pip install psd-tools")
    # Create dummy BlendMode for BLEND_MODE_MAP
    class BlendMode:
        pass
...
if PSD_TOOLS_AVAILABLE:
    NODE_CLASS_MAPPINGS["StarPSDSaverAdvLayers"] = StarPSDSaverAdvLayers
    NODE_DISPLAY_NAME_MAPPINGS["StarPSDSaverAdvLayers"] = "⭐ Star PSD Saver Adv. Layers"
else:
    print("[StarPSDSaverAdvLayers] Node not registered due to missing dependency: psd-tools. Install with: pip install psd-tools")

...
class StarEasyTextStorage:
    ...
    def __init__(self):
        ...
        self.nodes_storage_file = os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "json", "startext.json")
        
        # Use the same storage file for all operations so everything is kept in json/startext.json

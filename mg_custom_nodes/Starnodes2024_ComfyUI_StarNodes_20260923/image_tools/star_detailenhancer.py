...
try:
    ...
    CV2_AVAILABLE = False
    print("[AdaptiveDetailEnhancement] Warning: 'opencv-python' not installed. Install with: pip install opencv-python")
...
if CV2_AVAILABLE:
    ...
    print("[AdaptiveDetailEnhancement] Node not registered due to missing dependency: opencv-python. Install with: pip install opencv-python")
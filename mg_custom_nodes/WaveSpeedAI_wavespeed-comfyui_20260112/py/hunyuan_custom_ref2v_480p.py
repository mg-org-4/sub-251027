...
from .wavespeed_api.requests.hunyuan_custom_ref2v_480p import HunyuanCustomRef2V480p


class HunyuanCustomRef2V480pNode:
    """
    Hunyuan Custom Ref2V 480p Node
    """
    ...
    def execute(self,
        ...
        request = HunyuanCustomRef2V480p(
            prompt=prompt,
...
NODE_CLASS_MAPPINGS = {
    "WaveSpeedAI HunyuanCustomRef2V480pNode": HunyuanCustomRef2V480pNode
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "WaveSpeedAI HunyuanCustomRef2V480pNode": "WaveSpeedAI Hunyuan Custom Ref2V 480p"
}

...
from .wavespeed_api.requests.wan_2_1_i2v_480p_lora_ultra_fast import Wan2x1I2v480pLoraUltraFast


class Wan2x1I2V480pLoraUltraFastNode:
    """
    Wan 2.1 I2V 480p LoRA Ultra Fast Node

    This node uses WaveSpeed AI's Wan 2.1 model to generate videos from an image and prompt with LoRA support.
    """
    ...
    def INPUT_TYPES(s):
        return {
            "required": {
                ...
                "image_url": ("STRING", {"tooltip": "An image to be used as the start frame of the generated video.", "forceInput": False}),
    ...
    def execute(self,
        ...
        request = Wan2x1I2v480pLoraUltraFast(
            prompt=prompt,
...
NODE_CLASS_MAPPINGS = {
    "WaveSpeedAI Wan21I2V480pLoraUltraFastNode": Wan2x1I2V480pLoraUltraFastNode
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "WaveSpeedAI Wan21I2V480pLoraUltraFastNode": "WaveSpeedAI Wan2.1 I2V 480p LoRA Ultra Fast"
}
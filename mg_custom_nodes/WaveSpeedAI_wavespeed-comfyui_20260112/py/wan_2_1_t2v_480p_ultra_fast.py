...
from .wavespeed_api.requests.wan_2_1_t2v_480p_ultra_fast import Wan2x1T2V480pUltraFast


class Wan2x1T2V480pUltraFastNode:
    ...
    def execute(self,
        ...
        request = Wan2x1T2V480pUltraFast(
            prompt=prompt,
...
NODE_CLASS_MAPPINGS = {
    "WaveSpeedAI Wan21T2V480pUltraFastNode": Wan2x1T2V480pUltraFastNode
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "WaveSpeedAI Wan21T2V480pUltraFastNode": "WaveSpeedAI Wan2.1 T2V 480p Ultra Fast"
}

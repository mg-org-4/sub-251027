...
from .wavespeed_api.requests.wan_2_1_t2v_720p import Wan2x1T2V720p

class Wan2x1T2V720pNode:
    """
    Wan 2.1 Text-to-Video 720p Node
    """
...
NODE_CLASS_MAPPINGS = {
    "WaveSpeedAI Wan21T2V720pNode": Wan2x1T2V720pNode
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "WaveSpeedAI Wan21T2V720pNode": "WaveSpeedAI Wan2.1 T2V 720p"
}
...
from .wavespeed_api.requests.wan_2_1_t2v_720p_ultra_fast import Wan2x1T2v720pUltraFast

class Wan2x1T2v720pUltraFastNode:
    """
    ComfyUI node for Wan 2.1 720p Ultra Fast Text-to-Video API.
    """
    ...
    def execute(self,
        ...
        request = Wan2x1T2v720pUltraFast(
            prompt=prompt,
...
NODE_CLASS_MAPPINGS = {
    "WaveSpeedAI Wan21T2V720pUltraFastNode": Wan2x1T2v720pUltraFastNode
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "WaveSpeedAI Wan21T2V720pUltraFastNode": "WaveSpeedAI Wan2.1 T2V 720p Ultra Fast"
}
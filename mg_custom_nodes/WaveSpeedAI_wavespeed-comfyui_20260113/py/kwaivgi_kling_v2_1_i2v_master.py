...
from .wavespeed_api.requests.kwaivgi_kling_v2_1_i2v_master import KwaivgiKlingV2x1I2vMaster

class KwaivgiKlingV21I2vMasterNode:
    """
    Kwaivgi Kling V2.1 Image-to-Video Master Node
    """
    ...
    def execute(self,
        ...
        request = KwaivgiKlingV2x1I2vMaster(
            prompt=prompt,
            image=image,
...
NODE_CLASS_MAPPINGS = {
    "WaveSpeedAI KwaivgiKlingV21I2vMasterNode": KwaivgiKlingV21I2vMasterNode
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "WaveSpeedAI KwaivgiKlingV21I2vMasterNode": "WaveSpeedAI Kling v2.1 I2V Master"
} 
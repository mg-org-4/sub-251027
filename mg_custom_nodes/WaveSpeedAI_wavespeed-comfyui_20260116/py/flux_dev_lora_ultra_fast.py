...
from .wavespeed_api.requests.flux_dev_lora_ultra_fast import FluxDevLoraUltraFast


class FluxDevLoraUltraFastNode:
    """
    Flux Image Generator Node (Ultra Fast)

    This node uses WaveSpeed AI's Flux model to generate high-quality images with LoRA support, ultra fast.
    """
...
NODE_CLASS_MAPPINGS = {
    "WaveSpeedAI FluxDevLoraUltraFastNode": FluxDevLoraUltraFastNode
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "WaveSpeedAI FluxDevLoraUltraFastNode": "WaveSpeedAI Flux Dev Lora Ultra Fast"
}

...
from .wavespeed_api.requests.wan_2_1_i2v_720p_ultra_fast import Wan2x1I2V720pUltraFast

class Wan2x1I2V720pUltraFastNode:
    """
    Wan 2.1 I2V 720p Ultra Fast Node
    
    This node uses WaveSpeed AI's Wan 2.1 I2V-14B model to generate 720P videos from images.
    """
    ...
    def execute(self,
        ...
        request = Wan2x1I2V720pUltraFast(
            prompt=prompt,
...
NODE_CLASS_MAPPINGS = {
    "WaveSpeedAI Wan21I2V720pUltraFastNode": Wan2x1I2V720pUltraFastNode
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "WaveSpeedAI Wan21I2V720pUltraFastNode": "WaveSpeedAI Wan2.1 I2V 720p Ultra Fast"
}
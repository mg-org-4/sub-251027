...
from .wavespeed_api.requests.wan_2_1_t2v_720p_lora_ultra_fast import Wan2x1T2v720pLoraUltraFast


class Wan2x1T2v720pLoraUltraFastNode:
    ...
    def execute(self,
        ...
        request = Wan2x1T2v720pLoraUltraFast(
            prompt=prompt,
...
NODE_CLASS_MAPPINGS = {
    "WaveSpeedAI Wan21T2V720pLoraUltraFastNode": Wan2x1T2v720pLoraUltraFastNode
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "WaveSpeedAI Wan21T2V720pLoraUltraFastNode": "WaveSpeedAI Wan2.1 T2V 720p LoRA Ultra Fast"
}
...
from .wavespeed_api.requests.kwaivgi_kling_v2_1_i2v_pro import KwaivgiKlingV2x1I2vPro

class KwaivgiKlingV21I2vProNode:
    """
    Kwaivgi Kling V2.1 Image-to-Video Pro Node
    """
    ...
    def execute(self,
        ...
        request = KwaivgiKlingV2x1I2vPro(
            prompt=prompt,
            image=image,
...
NODE_CLASS_MAPPINGS = {
    "WaveSpeedAI KwaivgiKlingV21I2vProNode": KwaivgiKlingV21I2vProNode
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "WaveSpeedAI KwaivgiKlingV21I2vProNode": "WaveSpeedAI Kling v2.1 I2V Pro"
} 
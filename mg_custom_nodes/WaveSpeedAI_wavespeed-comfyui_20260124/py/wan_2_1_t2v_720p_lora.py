...
from .wavespeed_api.requests.wan_2_1_t2v_720p_lora import Wan2x1T2V720pLora

class Wan2x1T2V720pLoraNode:
    """
    Wan 2.1 T2V 720p LoRA Node

    This node uses WaveSpeed AI's Wan 2.1 model to generate 720p videos from text with LoRA support.
    """
...
NODE_CLASS_MAPPINGS = {
    "WaveSpeedAI Wan21T2V720pLoraNode": Wan2x1T2V720pLoraNode
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "WaveSpeedAI Wan21T2V720pLoraNode": "WaveSpeedAI Wan2.1 T2V 720p LoRA"
}
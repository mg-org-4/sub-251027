...
from .wavespeed_api.requests.wan_2_1_t2v_480p_lora import Wan21T2V480pLora

class Wan21T2V480pLoraNode:
    """
    WaveSpeed AI Wan 2.1 Text-to-Video Node (480p, LoRA)

    This node uses WaveSpeed AI's Wan 2.1 model to generate 480p videos from text prompts with LoRA support.
    """
...
NODE_CLASS_MAPPINGS = {
    "WaveSpeedAI Wan21T2V480pLoraNode": Wan21T2V480pLoraNode
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "WaveSpeedAI Wan21T2V480pLoraNode": "WaveSpeedAI Wan2.1 T2V 480p LoRA"
}
...
class Florence2Seq2SeqLMOutput(ModelOutput):
    ...
    Args:
        loss (`torch.FloatTensor` of shape `(1,)`, *optional*):
            Language modeling loss (for conditional generation).
        ...
        cross_attentions (`tuple(torch.FloatTensor)`, *optional*):
            Tuple of `torch.FloatTensor` (one for each layer) of shape `(batch_size, num_heads, sequence_length,
            sequence_length)`. Cross-attentions weights of the decoder, after the attention softmax, used to
        ...
        image_hidden_states (`tuple(torch.FloatTensor)`, *optional*):
            Tuple of `torch.FloatTensor` (one for the output of the vision encoder) of shape `(batch_size, num_images,
            hidden_size)`. Hidden states of the image encoder outputs.
    """

# Modified from https://github.com/OpenMOSS/MOVA/blob/main/mova/diffusion/models/dac_vae.py
"""
...
class AutoencoderKLMOVAAudio(ModelMixin, ConfigMixin):
    ...
    def get_output_length(self, input_length):
        """Calculate output length based on input length through all conv layers."""
        L = input_length
    ...
    def get_delay(self):
        """Calculate the delay introduced by the model."""

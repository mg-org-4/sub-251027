...
def usp_attn_flashhead_forward(self,
                               x,
                               seq_lens,
                               grid_sizes,
                               freqs,
                               ...
                               t=0):
    """
    FlashHead specific self-attention forward with xFuser support.
    Similar to WanSelfAttention but with sequence parallel.
    """

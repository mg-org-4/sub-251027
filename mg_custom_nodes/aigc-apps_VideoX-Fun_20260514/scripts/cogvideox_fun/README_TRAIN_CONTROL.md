# CogVideoX-Fun Control Full Parameter Training Guide
...
> **Note**: CogVideoX-Fun Control is a video generation model that supports controllable video generation (e.g., pose control). This document covers the training workflow for Control model.

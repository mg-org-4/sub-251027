...
| `--seed` | Random seed | 42 |
| `--output_dir` | Output directory | `output_dir_wan2.1_fun` |
...
| `--train_mode` | Training mode: `inpaint` (video inpainting) | `inpaint` |
...
| `save_path` | Path to save generated video | `samples/wan-videos-fun-t2v` or `samples/wan-videos-fun-i2v` |

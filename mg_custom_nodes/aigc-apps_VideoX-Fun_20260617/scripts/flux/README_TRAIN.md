# FLUX.1 Full Parameter Training Guide

This document provides a complete workflow for full parameter training of FLUX.1 Diffusion Transformer, including environment configuration, data preparation, distributed training, and inference testing.
...
| `--seed` | Random seed | 42 |
| `--output_dir` | Output directory | `output_dir_flux` |
...
# Trained weights path, e.g., "output_dir_flux/checkpoint-xxx/diffusion_pytorch_model.safetensors"

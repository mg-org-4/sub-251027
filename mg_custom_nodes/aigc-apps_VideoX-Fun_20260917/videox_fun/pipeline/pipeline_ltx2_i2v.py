...
from ..models import (AutoencoderKLLTX2Audio, AutoencoderKLLTX2Video, Gemma3Processor,
                      Gemma3ForConditionalGeneration, GemmaTokenizer,
                      GemmaTokenizerFast, LTX2TextConnectors,
                      LTX2VideoTransformer3DModel, LTX2Vocoder, LTX2VocoderWithBWE)
...
class LTX2I2VPipeline(DiffusionPipeline, FromSingleFileMixin):
    ...
    def _get_gemma_prompt_embeds(
        ...
        # Use processor if available (LTX-2.3), otherwise use tokenizer directly
        if getattr(self, "processor", None) is not None:
            # LTX-2.3: Use processor with chat template

# Modified from https://github.com/huggingface/diffusers/blob/cp-support-qwenimage2.1/src/diffusers/models/autoencoders/autoencoder_kl_qwenimage21.py
...
class AutoencoderKLQwenImage21(ModelMixin, ConfigMixin, FromOriginalModelMixin):
    r"""
    A VAE model with KL loss for encoding images/videos into latents and decoding latent representations.
    Introduced in Qwen-Image 2.1.
    ...
    def enable_slicing(self) -> None:
        ...
        compute decoding in several steps.
        """

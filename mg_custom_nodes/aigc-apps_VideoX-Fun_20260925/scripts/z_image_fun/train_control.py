...
def main():
    ...
    if args.use_ema:
        ...
        ema_module = ZImageControlTransformer2DModel.from_pretrained(
            args.pretrained_model_name_or_path, 
            subfolder="transformer",
            torch_dtype=weight_dtype,
            low_cpu_mem_usage=True,
        ...
        if args.use_fsdp:
            ...
            ema_transformer3d = EMAModel(ema_module.parameters(), model_cls=ZImageControlTransformer2DModel, model_config=ema_module.config)

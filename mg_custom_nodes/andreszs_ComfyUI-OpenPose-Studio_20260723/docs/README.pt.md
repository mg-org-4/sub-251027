...
![Mão selecionada com controles de transformação e edição](../locales/en/openpose-studio-hand-tools.png)
...
![Editor focado de keypoints da mão](../locales/en/openpose-studio-hand-editor.png)

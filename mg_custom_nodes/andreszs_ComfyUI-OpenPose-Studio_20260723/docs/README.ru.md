...
![Выбранная рука с элементами управления трансформацией и редактированием](../locales/en/openpose-studio-hand-tools.png)
...
![Отдельный редактор keypoints руки](../locales/en/openpose-studio-hand-editor.png)

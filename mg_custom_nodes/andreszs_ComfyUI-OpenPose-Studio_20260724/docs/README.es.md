...
![Mano seleccionada con controles de transformación y edición](../locales/en/openpose-studio-hand-tools.png)
...
![Editor enfocado de Keypoints de la mano](../locales/en/openpose-studio-hand-editor.png)

﻿<h4 align="center">
  <a href="./README.md">English</a> | <a href="./README.de.md">Deutsch</a> | <a href="./README.es.md">Español</a> | <a href="./README.fr.md">Français</a> | <a href="./README.hi.md">हिन्दी</a> | <a href="./README.pt.md">Português</a> | <a href="./README.ru.md">Русский</a> | <a href="./README.ja.md">日本語</a> | 한국어 | <a href="./README.zh.md">中文</a> | <a href="./README.zh-TW.md">繁體中文</a>
</h4>
...
![변형 및 편집 컨트롤이 표시된 선택된 손](../locales/ko/openpose-studio-hand-tools-2.png)
...
![손 키포인트 전용 에디터](../locales/ko/openpose-studio-hand-editor-2.png)
...
이 에디터는 **OpenPose COCO-18 (body)** 편집과 **OpenPose 손 키포인트**의 개별 편집을 완전히 지원합니다. Face 키포인트는 유지되고 렌더링되지만 계속 *패스스루* 데이터로 처리되며 현재 개별 편집은 지원되지 않습니다.
...
> [!NOTE]
> Nodes 2.0은 지원됩니다. preview canvas 또는 editor 버튼이 보이지 않으면 브라우저 캐시, frontend 로딩, 설치 로그를 확인하세요.

### 현재 제한 사항 및 우회 방법

1. **Face 편집**
  - Face 키포인트는 유지되고 렌더링되지만 현재 Canvas에서 개별적으로 편집할 수 없습니다.
...
3. **Nodes 2.0 호환성**
  - 상태: 현재 버전에서 지원됩니다.
  - 참고: editor UI가 나타나지 않으면 오래된 브라우저 캐시, frontend 모듈 로딩 실패 또는 불완전한 설치가 가장 가능성 높은 원인입니다.
  - 진단: ComfyUI를 완전히 다시 시작하고 브라우저를 강력 새로고침한 뒤, 브라우저 콘솔과 ComfyUI 시작 로그를 확인하세요.

<h4 align="center">
  <a href="./README.md">English</a> | <a href="./README.de.md">Deutsch</a> | <a href="./README.es.md">Español</a> | Français | <a href="./README.hi.md">हिन्दी</a> | <a href="./README.pt.md">Português</a> | <a href="./README.ru.md">Русский</a> | <a href="./README.ja.md">日本語</a> | <a href="./README.ko.md">한국어</a> | <a href="./README.zh.md">中文</a> | <a href="./README.zh-TW.md">繁體中文</a>
</h4>
...
- Édition individuelle des keypoints des mains dans un éditeur focalisé et agrandi
...
Cet éditeur prend entièrement en charge l'édition **OpenPose COCO-18 (body)** ainsi que l'édition individuelle des **keypoints de mains OpenPose**. Les keypoints du visage sont conservés et rendus, mais restent des données *pass-through* et ne peuvent pas encore être modifiés individuellement.
...
Le module **Render** permet de personnaliser le rendu du stickman OpenPose lors de l'exécution du workflow. Il inclut des contrôles de style pour body, hands et face, comme la largeur de ligne, le rayon des keypoints et la couleur des keypoints pour hands/face.

Les paramètres Render sont enregistrés localement dans le local storage de ce navigateur, pas dans le workflow. Les modifier affecte les exécutions suivantes du workflow.
...
1. **Édition du visage**
  - Les keypoints du visage sont conservés et rendus, mais ne peuvent pas encore être modifiés individuellement sur le canvas.

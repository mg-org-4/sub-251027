<h4 align="center">
  <a href="./README.md">English</a> | <a href="./README.de.md">Deutsch</a> | Español | <a href="./README.fr.md">Français</a> | <a href="./README.hi.md">हिन्दी</a> | <a href="./README.pt.md">Português</a> | <a href="./README.ru.md">Русский</a> | <a href="./README.ja.md">日本語</a> | <a href="./README.ko.md">한국어</a> | <a href="./README.zh.md">中文</a> | <a href="./README.zh-TW.md">繁體中文</a>
</h4>
...
- Edición individual de Keypoints de manos en un editor enfocado y ampliado
...
Las manos OpenPose importadas pueden transformarse como un grupo o ajustarse Keypoint por Keypoint. Selecciona una mano en el Canvas para mostrar su recuadro de transformación y usa los controles que la rodean para redimensionarla, rotarla, reflejarla o abrir el editor enfocado de manos.

![Mano seleccionada con controles de transformación y edición](../locales/es/openpose-studio-hand-tools-2.png)

También puedes abrir el editor enfocado directamente desde el icono del lápiz junto a **Left hand** o **Right hand** en el sidebar. En esta vista, arrastra los Keypoints 1–20 para ajustar los dedos; el Keypoint 0 permanece bloqueado como ancla de la mano. Al pasar el mouse sobre una entrada del sidebar se resalta el punto correspondiente. Usa el botón de confirmación para aplicar toda la sesión como un único cambio que puede deshacerse, o el botón de cerrar o **Escape** para descartarla.

![Editor enfocado de Keypoints de la mano](../locales/es/openpose-studio-hand-editor-2.png)
...
Este editor soporta completamente la edición de **OpenPose COCO-18 (body)** y la edición individual de **Keypoints de manos OpenPose**. Los Keypoints de face se preservan y renderizan, pero continúan siendo datos *pass-through* y actualmente no pueden editarse de forma individual.
...
El módulo **Render** permite personalizar cómo se renderiza el stickman de OpenPose cuando se ejecuta el workflow. Incluye controles de estilo para body, hands y face, como ancho de línea, radio de keypoint y color de keypoint para hands/face.

Los ajustes de Render se guardan localmente en el local storage de este navegador, no en el workflow. Cambiarlos afecta las ejecuciones posteriores del workflow.
...
> [!NOTE]
> Nodes 2.0 está soportado. Si falta el canvas de preview o el botón del editor, revisa la caché del navegador, la carga del frontend y los logs de instalación.

### Limitaciones actuales y workarounds

1. **Edición de Face**
  - Los Keypoints de face se preservan y renderizan, pero actualmente no pueden editarse individualmente en el Canvas.
...
3. **Compatibilidad con Nodes 2.0**
  - Estado: Soportado en las versiones actuales.
  - Nota: Si la UI del editor no aparece, las causas más probables son caché vieja del navegador, fallo al cargar módulos del frontend o una instalación incompleta.
  - Diagnóstico: Reinicia ComfyUI por completo, fuerza la recarga del navegador y revisa la consola del navegador junto con el log de inicio de ComfyUI.

﻿<h4 align="center">
  <a href="./README.md">English</a> | <a href="./README.de.md">Deutsch</a> | <a href="./README.es.md">Español</a> | <a href="./README.fr.md">Français</a> | <a href="./README.hi.md">हिन्दी</a> | <a href="./README.pt.md">Português</a> | <a href="./README.ru.md">Русский</a> | <a href="./README.ja.md">日本語</a> | <a href="./README.ko.md">한국어</a> | 中文 | <a href="./README.zh-TW.md">繁體中文</a>
</h4>
...
![带有变换和编辑控件的已选手部](../locales/zh/openpose-studio-hand-tools-2.png)
...
![聚焦手部 Keypoint 编辑器](../locales/zh/openpose-studio-hand-editor-2.png)
...
本编辑器完整支持 **OpenPose COCO-18 (body)** 编辑以及单独编辑 **OpenPose 手部 Keypoints**。Face Keypoints 会被保留和渲染，但仍作为 *pass-through* 数据处理，目前无法单独编辑。
...
**Render** 模块可自定义 workflow 执行时 OpenPose stickman 的渲染方式。它提供 body、hands 和 face 的样式控制，例如线宽、keypoint 半径，以及 hands/face 的 keypoint 颜色。

Render 设置会本地保存在此浏览器的 local storage 中，而不是保存在 workflow 中。更改这些设置会影响后续 workflow 执行。
...
> [!NOTE]
> Nodes 2.0 已受支持。如果缺少预览 canvas 或编辑器按钮，请检查浏览器缓存、frontend 加载以及安装日志。

### 当前限制与变通方案

1. **Face 编辑**
  - Face Keypoints 会被保留和渲染，但目前无法在 Canvas 上单独编辑。
...
3. **Nodes 2.0 兼容性**
  - 状态：当前版本已支持。
  - 说明：如果编辑器 UI 没有出现，最可能的原因是浏览器缓存过旧、frontend 模块加载失败或安装不完整。
  - 诊断：完全重启 ComfyUI，强制刷新浏览器，并检查浏览器控制台和 ComfyUI 启动日志。

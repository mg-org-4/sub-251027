...
NODE_CLASS_MAPPINGS = {
    "ComfyUI-Krea2T-Enhancer": ComfyUIKrea2TEnhancer,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "ComfyUI-Krea2T-Enhancer": "ComfyUI-Krea2T-Enhancer",
}

from .advanced import NODE_CLASS_MAPPINGS as _ADVANCED_NODE_CLASS_MAPPINGS
...
from .character_lora_image_only import NODE_CLASS_MAPPINGS as _CHARACTER_NODE_CLASS_MAPPINGS
from .character_lora_image_only import NODE_DISPLAY_NAME_MAPPINGS as _CHARACTER_NODE_DISPLAY_NAME_MAPPINGS
...
NODE_CLASS_MAPPINGS.update(_CHARACTER_NODE_CLASS_MAPPINGS)
NODE_DISPLAY_NAME_MAPPINGS.update(_CHARACTER_NODE_DISPLAY_NAME_MAPPINGS)

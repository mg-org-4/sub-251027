...
class UnetLoaderGGUFAdvanced(UnetLoaderGGUF2):
    @classmethod
    def INPUT_TYPES(s):
        unet_names = [x for x in folder_paths.get_filename_list("unet_gguf")]
        return {
...
class DualCLIPLoaderGGUF(CLIPLoaderGGUF2):
    @classmethod
    def INPUT_TYPES(s):
...
class TripleCLIPLoaderGGUF(CLIPLoaderGGUF2):
    @classmethod
    def INPUT_TYPES(s):
        file_options = (s.get_filename_list(), )
        return {
...
class QuadrupleCLIPLoaderGGUF(CLIPLoaderGGUF2):
    @classmethod
    def INPUT_TYPES(s):
        file_options = (s.get_filename_list(), )
        return {

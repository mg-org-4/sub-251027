...
from ._compat import OffloadedCache, isin_mps_friendly
...
# transformers>=5 已移除 generation.beam_constraints / beam_search 模块，统一走 vendor 内兼容层
from ._compat import DisjunctiveConstraint, PhrasalConstraint
...
from ._compat import HammingDiversityLogitsProcessor, QuantizedCacheConfig, NEED_SETUP_CACHE_CLASSES_MAPPING, QUANT_BACKEND_CLASSES_MAPPING

...
function installStyles() {
  ...
  style.textContent = `
    ...
    /* Seed / resolution controls style themselves (borderless Kippschalter
       track, attached ▲/▼ spinner, framed res buttons); exempt them from the
       generic button base so their intended look is not overridden by it. */
    .ds-h3 button:not(.ds-h3-res-btn,.ds-h3-res-switch-seg,.ds-h3-res-spinbtn){background:#202b35;color:#dbe7f0;border:1px solid #40515e;border-radius:4px;padding:4px 7px;cursor:pointer}.ds-h3 button:hover:not(.ds-h3-res-btn,.ds-h3-res-switch-seg,.ds-h3-res-spinbtn){background:#2c3c49}.ds-h3-lane-add{position:absolute;right:6px;z-index:3;width:22px;height:22px;padding:0!important;border-radius:50%!important;font-size:17px;line-height:18px;background:rgba(70,150,105,.3)!important;border-color:rgba(126,210,157,.75)!important;color:#bff3d0!important}
  ...
  style.textContent += `.ds-h3-res-field{display:flex;flex-direction:column;gap:3px;min-width:168px;font-size:10px;font-weight:600;letter-spacing:.4px;color:#8fb3d6;text-transform:uppercase}.ds-h3-res-control{display:flex;position:relative}.ds-h3-res-select{position:absolute;inset:0;width:100%;opacity:0;pointer-events:none}.ds-h3-res-btn{width:100%;display:flex;align-items:center;gap:8px;box-sizing:border-box;margin:0;min-height:34px;padding:0 9px;background:#16283a;border:1px solid #2f5478;border-radius:5px;color:#d6ebff;font:12px system-ui,sans-serif;cursor:pointer;text-align:left;transition:background .16s ease,border-color .16s ease,box-shadow .16s ease}.ds-h3-res-btn:hover:not(:disabled){background:#1d3550;border-color:#3f79b4;box-shadow:0 0 9px rgba(74,144,217,.28)}.ds-h3-res-btn:focus-visible{outline:none;border-color:#4f97d6;box-shadow:0 0 0 2px rgba(74,144,217,.35)}.ds-h3-res-btn:disabled{opacity:.4;cursor:not-allowed}.ds-h3-res-label{flex:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.ds-h3-res-caret{flex:none;color:#6fa8e0;font-size:9px;transition:transform .18s ease}.ds-h3-res-btn[aria-expanded="true"] .ds-h3-res-caret{transform:rotate(180deg)}.ds-h3-res-swatch{flex:none;display:flex;align-items:center;justify-content:center;width:20px;height:20px}.ds-h3-res-swatch-box{background:#3f79b4;border:1px solid #9fd0ff;border-radius:1px;box-shadow:inset 0 0 4px rgba(0,0,0,.4);transition:background .16s ease,border-color .16s ease,box-shadow .16s ease}.ds-h3-res-btn:hover:not(:disabled) .ds-h3-res-swatch-box,.ds-h3-res-btn[aria-expanded="true"] .ds-h3-res-swatch-box{background:#5b9be0;border-color:#c4e4ff}.ds-h3-res-menu{position:absolute;top:calc(100% + 4px);left:0;z-index:2500;min-width:100%;max-height:290px;overflow-y:auto;padding:4px;background:#101c28;border:1px solid #35618f;border-radius:6px;box-shadow:0 10px 30px rgba(0,0,0,.65);display:none}.ds-h3-res-menu.open{display:block}.ds-h3-res-menu.grid.open{display:grid;gap:2px}.ds-h3-res-menu.grid .ds-h3-res-item-label{white-space:normal;overflow-wrap:anywhere}.ds-h3-res-menu[data-place="up"]{top:auto;bottom:calc(100% + 4px)}.ds-h3-res-item{display:flex;align-items:center;gap:8px;width:100%;box-sizing:border-box;padding:6px 9px;background:transparent;border:0;border-radius:4px;color:#cfe3f7;font:12px system-ui,sans-serif;cursor:pointer;text-align:left;transition:background .12s ease,color .12s ease,box-shadow .12s ease}.ds-h3-res-item:hover{background:rgba(74,144,217,.24);color:#fff;box-shadow:inset 0 0 0 1px rgba(96,168,232,.35)}.ds-h3-res-item.active{background:rgba(74,144,217,.34);color:#fff;font-weight:600;box-shadow:inset 0 0 0 1px rgba(120,190,255,.55)}.ds-h3-res-item.active:hover{background:rgba(74,144,217,.44)}.ds-h3-res-item-label{flex:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.ds-h3-res-num{width:100%;box-sizing:border-box;height:34px;padding:0 8px;background:#16283a;border:1px solid #2f5478;border-radius:5px;color:#d6ebff;font:12px system-ui,sans-serif;transition:background .16s ease,border-color .16s ease,box-shadow .16s ease}.ds-h3-res-num:hover:not(:disabled){background:#1d3550;border-color:#3f79b4}.ds-h3-res-num:focus{outline:none;border-color:#4f97d6;box-shadow:0 0 0 2px rgba(74,144,217,.3)}.ds-h3-res-num:disabled{opacity:.4;cursor:not-allowed}.ds-h3-res-menu.cols.open{display:flex;align-items:flex-start;gap:7px}.ds-h3-res-col{display:flex;flex-direction:column;gap:2px;min-width:84px}.ds-h3-res-col-title{font-size:9px;font-weight:700;letter-spacing:.5px;text-transform:uppercase;color:#6fa8e0;padding:1px 9px 3px;border-bottom:1px solid #2f5478;margin-bottom:2px}.ds-h3-res-menu.cols .ds-h3-res-item{white-space:nowrap}
    ...
    .ds-h3-res-spinbtn{flex:1;display:flex;align-items:center;justify-content:center;box-sizing:border-box;margin:0;border:none;background:#16283a;color:#d6ebff;font:9px system-ui,sans-serif;cursor:pointer;padding:0;user-select:none;appearance:none;-webkit-appearance:none;transition:background .08s,color .08s}
    ...
    /* Random|Fixed as ONE switch: a single segmented pill with two segments,
       matching the Pixaroma mode toggle; active segment outlined in green. */
    .ds-h3-res-switch{box-sizing:border-box;display:flex;align-items:stretch;gap:0;background:rgba(255,255,255,.05);border:none;border-radius:6px;padding:2px;height:34px;overflow:hidden}
    .ds-h3-res-switch-seg{flex:1;min-width:56px;display:flex;align-items:center;justify-content:center;box-sizing:border-box;margin:0;border:none;background:transparent;color:#8fb3d6;font:12px system-ui,sans-serif;cursor:pointer;padding:0 6px;border-radius:4px;white-space:nowrap;user-select:none;appearance:none;-webkit-appearance:none;transition:background .16s ease,color .16s ease}
    .ds-h3-res-switch-seg:hover{background:rgba(255,255,255,.08);color:#d6ebff}
    .ds-h3-res-switch-seg.active{background:#0f2a1a;color:#7ee19d;font-weight:600}`;
...
function install(node) {
  ...
  const render = () => {
    ...
    if (externalSeed) { const external = document.createElement("span"); external.textContent = "External seed connected"; external.style.cssText = "font-size:11px;color:#9fb3c2;white-space:nowrap;padding-bottom:4px"; seedControl.append(external); } else {
      ...
      const rollSeedValue = () => { const words = crypto.getRandomValues(new Uint32Array(2)); return ((BigInt(words[0]) << 32n) | BigInt(words[1])).toString(); };
      // The native number widget coerces 16-digit values to a lossy JS number,
      // so the panel keeps its own lossless decimal string as the source of
      // truth for display and stepping, and only WRITES the widget as a
      // mirror (never reads it back) — the same architecture as Pixaroma's
      // properties-based seed.
      let lastSeedText = controlState.last_seed || String(seed?.value ?? 0);
      const writeSeedMirror = text => { if (seed) { seed.value = text; seed.callback?.(text); } node.setDirtyCanvas?.(true, true); };
      const remember = value => { controlState.last_seed = value; controlState.recent = [value, ...controlState.recent.filter(entry => entry !== value)].slice(0, 10); };
      if (controlState.mode === "random" && !controlState.last_seed && lastSeedText === "0") { const value = rollSeedValue(); lastSeedText = value; writeSeedMirror(value); remember(value); emit(); }
      const toggle = document.createElement("div"); toggle.className = "ds-h3-res-switch"; toggle.role = "group"; toggle.title = "Seed mode: Random rolls a new seed on every queue, Fixed keeps the current seed.";
      const segButtons = []; let lastBtn = null;
      for (const [modeKey, modeLabel] of [["random", "Random"], ["fixed", "Fixed"]]) { const button = document.createElement("button"); button.type = "button"; button.className = "ds-h3-res-switch-seg" + (controlState.mode === modeKey ? " active" : ""); button.textContent = modeLabel; button.dataset.mode = modeKey; button.title = modeKey === "random" ? "Roll a new seed on every queue" : "Keep the current seed on every queue (repeatable)"; button.onclick = () => { if (controlState.mode === modeKey) return; controlState.mode = modeKey; if (modeKey === "fixed") remember(lastSeedText); emit(); syncSwitch(); }; segButtons.push(button); toggle.append(button); }
      const syncSwitch = () => { for (const button of segButtons) button.classList.toggle("active", button.dataset.mode === controlState.mode); if (lastBtn) lastBtn.disabled = !controlState.last_seed; };
      const seedField = document.createElement("label"); seedField.style.cssText = "display:flex;flex-direction:column;gap:3px;min-width:168px;font-size:10px;font-weight:600;letter-spacing:.4px;color:#8fb3d6;text-transform:uppercase"; seedField.textContent = "SEED";
      const numwrap = document.createElement("div"); numwrap.className = "ds-h3-res-numwrap"; numwrap.style.cssText = "min-width:168px";
      const input = document.createElement("input"); input.type = "text"; input.inputMode = "numeric"; input.className = "ds-h3-res-num"; input.style.textAlign = "center"; input.value = lastSeedText; input.title = "Unsigned 64-bit Director seed";
      input.onchange = event => { const digits = String(event.target.value ?? "").replace(/\D+/g, ""); const value = digits === "" ? "0" : BigInt(digits); if (value < 0n || value > maxSeed) { event.target.value = lastSeedText; return; } lastSeedText = value.toString(); writeSeedMirror(lastSeedText); controlState.mode = "fixed"; remember(lastSeedText); emit(); syncSwitch(); requestAnimationFrame(fitSeedFont); };
      // Spin in place (no render): step the lossless seed via BigInt with
      // 64-bit wrap, lock Fixed mode, and re-sync the switch.
      const stepSeed = delta => { let value = BigInt(lastSeedText || "0") + delta; if (value < 0n) value = maxSeed; else if (value > maxSeed) value = 0n; lastSeedText = value.toString(); input.value = lastSeedText; writeSeedMirror(lastSeedText); controlState.mode = "fixed"; remember(lastSeedText); emit(); syncSwitch(); fitSeedFont(); };
      // Shrink the seed font until the digits fit the 150px field (a full
      // 64-bit seed is up to 20 digits, wider than the 12px base font).
      // Idempotent and cheap, like Pixaroma's fitSeedFont.
      const fitSeedFont = () => { if (!input.isConnected) return; const MAX = 13, MIN = 9; input.style.fontSize = MAX + "px"; if (!input.clientWidth) return; let fs = MAX, guard = 0; while (fs > MIN && input.scrollWidth > input.clientWidth && guard++ < 24) { fs -= 1; input.style.fontSize = fs + "px"; } };
      const spin = document.createElement("div"); spin.className = "ds-h3-res-spin";
      const bindHoldRepeat = (button, stepFn) => { button.addEventListener("pointerdown", event => { if (event.button != null && event.button !== 0) return; event.preventDefault(); event.stopPropagation(); stepFn(); let interval = null; const timeout = setTimeout(() => { interval = setInterval(stepFn, 80); }, 400); const end = () => { clearTimeout(timeout); if (interval) clearInterval(interval); window.removeEventListener("pointerup", end, true); window.removeEventListener("pointercancel", end, true); button.removeEventListener("pointerleave", end); }; window.addEventListener("pointerup", end, true); window.addEventListener("pointercancel", end, true); button.addEventListener("pointerleave", end); }); };
      const spinButton = (glyph, title, delta) => { const button = document.createElement("button"); button.type = "button"; button.className = "ds-h3-res-spinbtn"; button.textContent = glyph; button.title = title; button.tabIndex = -1; bindHoldRepeat(button, () => stepSeed(delta)); return button; };
      spin.append(spinButton("▲", "Seed +1 (wraps at 2^64-1, locks Fixed). Hold to repeat.", 1n), spinButton("▼", "Seed -1 (wraps at 0, locks Fixed). Hold to repeat.", -1n));
      numwrap.append(input, spin); seedField.append(numwrap);

    ...
    def _sample(
        ...
        **model_kwargs,
        ...
        while self._has_unfinished_sequences(this_peer_finished, synced_gpus, device=input_ids.device):
            ...
            # TTS Audio Suite Patch: transformers<5 can miss EOS stopping for this
            # custom multi-channel generation path, so enforce channel-0 EOS here.
            if eos_token_id is not None:
                stopping = stopping | (next_tokens[:, 0] == eos_token_id)

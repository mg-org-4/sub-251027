...
- Clarify that parallel workers are available only for ChatterBox Classic
- Prevent unsupported TTS engines from entering experimental parallel processing

### Changed

- Improve legacy ChatterBox parallel-worker guidance
- Explain that the option is not true model batching and may not improve speed
## [5.8.7] - 2026-08-28
...
- Improve Vocal Removal cache hashing without temporary WAV encoding

### Fixed

- Fix Vocal Removal crashing before audio separation on systems with incompatible SoundFile virtual I/O
## [5.8.5] - 2026-08-26

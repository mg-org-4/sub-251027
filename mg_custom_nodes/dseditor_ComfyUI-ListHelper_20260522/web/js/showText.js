...
/**
 * Show Text extension for ComfyUI-ListHelper
 * Displays list-type text with proper segmentation
 */

app.registerExtension({
	name: "listhelper.ShowText",
	async beforeRegisterNodeDef(nodeType, nodeData, app) {
		if (nodeData.name === "ShowText|ListHelper") {
			/**
			 * Populate the node with text widgets for each list item
			 * @param {Array} text - Array of text items to display
			 */

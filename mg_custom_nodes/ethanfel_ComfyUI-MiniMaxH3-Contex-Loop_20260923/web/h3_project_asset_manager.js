...
import {
    ...
    formatMegapixels,
    imageMegapixels,
} from "./h3_project_asset_editor_core.mjs?v=0.6.11";
import {
...
} from "./h3_project_asset_carousel_core.mjs?v=0.6.12";
...
function mount(node) {
    ...
    if (treeLayout) root.append(top, status, tabs, sourceCol, stageCol, lineageDisplay);
    else root.append(top, status, tabs, stage, carousel);

...
export function taggedReferenceRecords(editorNode, prompt = "") {
    ...
    if (!wrapper) {
        ...
        // In that layout there is no traversable downstream Ref2VA wrapper,
        // but the connected Carousel catalog is still the authoritative set
        // of prompt references and must remain visible to the editor.

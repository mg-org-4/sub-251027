...
| `FL_GeminiTextAPI` | Generates text from a prompt and optional AUDIO, IMAGE, and native VIDEO inputs through Gemini's Interactions API. Supports mixed media, image/audio batches, system instructions, and a model override. See [media inputs and music captioning](docs/gemini_music_captioning.md). |

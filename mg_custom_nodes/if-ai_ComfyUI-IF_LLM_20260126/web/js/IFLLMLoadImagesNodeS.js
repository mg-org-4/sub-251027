...
app.registerExtension({
    name: "Comfy.IFLLMLoadImagesNodeS",
    async beforeRegisterNodeDef(nodeType, nodeData) {
        if (nodeData.name !== "IF_LLM_LoadImagesS") return;
        ...
        nodeType.prototype.onNodeCreated = function() {
            ...
            const backupBtn = this.addWidget("button", "backup_input", "Backup Input 💾", 
                async () => {
                    try {
                        const response = await api.fetchApi("/IF_LLM/backup_input", {
                            method: "POST"
                        });
            ...
            const restoreBtn = this.addWidget("button", "restore_input", "Restore Input ♻️", 
                async () => {
                    try {
                        const response = await api.fetchApi("/IF_LLM/restore_input", {
                            method: "POST"
                        });
            ...
            const refreshBtn = this.addWidget("button", "refresh_preview", "Refresh Previews 🔄", async () => {
                try {
                    ...
                    const response = await api.fetchApi("/IF_LLM/refresh_previews", {
                        method: "POST",
        ...
        nodeType.prototype.backupInputFolder = async function() {
            try {
                this.showLoader();
                const response = await fetch("/IF_LLM/backup_input", {
                    method: "POST"
                });
        ...
        nodeType.prototype.restoreInputFolder = async function() {
            try {
                this.showLoader();
                const response = await fetch("/IF_LLM/restore_input", {
                    method: "POST"
                });
        ...
        nodeType.prototype.refreshPreviews = async function() {
            try {
                ...
                const response = await fetch("/IF_LLM/refresh_previews", {
                    method: "POST",
                    headers: {

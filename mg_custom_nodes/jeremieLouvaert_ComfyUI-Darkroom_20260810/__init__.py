...
print("\033[34m[ComfyUI-Darkroom] \033[92mLoaded — 59 nodes (Film Emulation + Camera Raw + Color Grading + Lens & Optics + LUT Pipeline + RAW Pipeline w/ DCP + Spectral Film Stock + Scopes + Color Match + CMYK Print)\033[0m")

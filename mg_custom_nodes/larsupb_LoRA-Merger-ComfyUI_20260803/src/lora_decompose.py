...
class AnyType(str):
    def __ne__(self, __value: object) -> False:
        return False
                ...
                "svd_rank": (
                    "INT",
                    {
                        ...
                        "tooltip": (
                            ...
                            "-1 = auto (keep the rank of the first LoRA in the stack). "
                            "Set a positive value to force a rank; lower values reduce "
                            "model size and strength."
                        ),
                    }
                ),
                "device": (["cuda", "cpu"],

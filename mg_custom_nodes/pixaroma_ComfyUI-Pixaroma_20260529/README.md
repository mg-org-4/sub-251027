...
- **Still in progress:** a few nodes that draw their own controls (the Switch family, Mute Switch, Preview Image, Image Compare, Reference, Load Image) are still being updated for Nodes 2.0 - for now they work best in the Classic interface. The new Version Check node shows you at a glance which interface you're in.

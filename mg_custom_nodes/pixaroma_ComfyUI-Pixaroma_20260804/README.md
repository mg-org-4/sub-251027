...
### **August 4, 2026 · v1.4.85–v1.4.88**
- **Pixaroma now works properly on online ComfyUI services.** If you use ComfyUI through a website rather than on your own PC, a lot of the pack was quietly broken there: the Save Mp4 player was black and would not play, Note icons showed as empty squares, and various pickers and panels did nothing. Everything worked once it reached your files, so the files were being made correctly, but your browser was asking for them at the wrong web address and getting turned away. Around 270 addresses across the pack were being built as if ComfyUI owned the whole website, which is true on your own PC and not true on a shared service. They now ask in the way those services expect, the same way other well behaved node packs do. Nothing changes when you run ComfyUI on your own computer.

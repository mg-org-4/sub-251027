      ...
      <div class="pix-note-help-content">
        ...
        <div class="pix-note-help-section">
          ...
          <div class="pix-note-help-grid">
            ...
            <b><img class="pix-note-tbtn-icon" src="/api/pixaroma/assets/icons/ui/clear-format.svg">Broom</b><span>Clear all formatting on selection; demotes headings to paragraph; unwraps code / lists</span>
          </div>
        </div>
        <div class="pix-note-help-section">
          <h4>Headings</h4>
        ...
        <div class="pix-note-help-section">
          ...
          <div class="pix-note-help-grid">
            ...
            <b><img class="pix-note-tbtn-icon" src="/api/pixaroma/assets/icons/ui/grid.svg">Grid</b><span>Centred modal: pick border and header colours, columns (2 to 4), rows (1 to 10), header on/off, click Insert. Each grid carries its own border and header colours. Tab navigates cells.</span>
        ...
        <div class="pix-note-help-section">
          ...
          <div class="pix-note-help-grid">
            <b><img class="pix-note-tbtn-icon" src="/api/pixaroma/assets/icons/ui/button-design.svg">Button</b><span>Centred modal: pick colour, button type (Download / View Page / Read More / No icon), label, URL, optional size hint. Each button carries its own colour. On the canvas, clicking the button opens its URL in a new tab.</span>
            <b><img class="pix-note-tbtn-icon" src="/api/pixaroma/assets/icons/ui/folder.svg">Folder hint</b><span>Standalone "Place in: ComfyUI/&lt;path&gt;" line. Centred modal: pick colour and folder path. Use it under a Button to tell the reader where to save the downloaded file. Purely informational; nothing happens on click.</span>
            <b><img class="pix-note-tbtn-icon" src="/api/pixaroma/assets/icons/ui/youtube.svg">YouTube</b><span>Centred modal with preset Pixaroma YouTube link (override freely). Brand red colour locked.</span>
            <b><img class="pix-note-tbtn-icon" src="/api/pixaroma/assets/icons/ui/discord.svg">Discord</b><span>Centred modal with preset Pixaroma Discord link (override freely). Brand blurple locked.</span>
          </div>
        </div>
        <div class="pix-note-help-section">
        ...
        <div class="pix-note-help-section">
          ...
          <div class="pix-note-help-grid">
            ...
            <b><img class="pix-note-tbtn-icon" src="/api/pixaroma/assets/icons/ui/undo.svg">Ctrl+Z</b><span>Undo</span>
            <b><img class="pix-note-tbtn-icon" src="/api/pixaroma/assets/icons/ui/redo.svg">Ctrl+Y / Ctrl+Shift+Z</b><span>Redo</span>

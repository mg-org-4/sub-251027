...
.pix-note-editarea a.pix-note-dl::before,
.pix-note-prevwrap a.pix-note-dl::before {
  -webkit-mask-image: url(${pixAsset("icons/ui/download-model.svg")});
          mask-image: url(${pixAsset("icons/ui/download-model.svg")});
}
.pix-note-body a.pix-note-yt::before,
.pix-note-editarea a.pix-note-yt::before,
.pix-note-prevwrap a.pix-note-yt::before {
  -webkit-mask-image: url(${pixAsset("icons/ui/youtube.svg")});
          mask-image: url(${pixAsset("icons/ui/youtube.svg")});
}
.pix-note-body a.pix-note-discord::before,
.pix-note-editarea a.pix-note-discord::before,
.pix-note-prevwrap a.pix-note-discord::before {
  -webkit-mask-image: url(${pixAsset("icons/ui/discord.svg")});
          mask-image: url(${pixAsset("icons/ui/discord.svg")});
}
.pix-note-body a.pix-note-vp::before,
.pix-note-editarea a.pix-note-vp::before,
.pix-note-prevwrap a.pix-note-vp::before {
  -webkit-mask-image: url(${pixAsset("icons/ui/view-model-page.svg")});
          mask-image: url(${pixAsset("icons/ui/view-model-page.svg")});
}
.pix-note-body a.pix-note-rm::before,
.pix-note-editarea a.pix-note-rm::before,
.pix-note-prevwrap a.pix-note-rm::before {
  -webkit-mask-image: url(${pixAsset("icons/ui/read-more.svg")});
          mask-image: url(${pixAsset("icons/ui/read-more.svg")});
}
...
.pix-note-prevwrap .pix-note-folderhint::before {
  ...
  width: 12px; height: 12px;
  background-color: currentColor;
  -webkit-mask: url(${pixAsset("icons/ui/folder.svg")}) no-repeat center / contain;
          mask: url(${pixAsset("icons/ui/folder.svg")}) no-repeat center / contain;
  vertical-align: -2px;
  margin-right: 6px;
  opacity: 0.85;
}
...
.pix-note-icon-text-color::before {
  -webkit-mask-image: url(${pixAsset("icons/ui/text-color-outline.svg")});
          mask-image: url(${pixAsset("icons/ui/text-color-outline.svg")});
}
.pix-note-icon-text-color::after {
  -webkit-mask-image: url(${pixAsset("icons/ui/text-color-drop.svg")});
          mask-image: url(${pixAsset("icons/ui/text-color-drop.svg")});
}
.pix-note-icon-highlight-color::before {
  -webkit-mask-image: url(${pixAsset("icons/ui/highlight-color-outline.svg")});
          mask-image: url(${pixAsset("icons/ui/highlight-color-outline.svg")});
}
.pix-note-icon-highlight-color::after {
  -webkit-mask-image: url(${pixAsset("icons/ui/highlight-color-drop.svg")});
          mask-image: url(${pixAsset("icons/ui/highlight-color-drop.svg")});
}
.pix-note-icon-bg-color::before {
  -webkit-mask-image: url(${pixAsset("icons/ui/bg-color-outline.svg")});
          mask-image: url(${pixAsset("icons/ui/bg-color-outline.svg")});
}
.pix-note-icon-bg-color::after {
  -webkit-mask-image: url(${pixAsset("icons/ui/bg-color-drop.svg")});
          mask-image: url(${pixAsset("icons/ui/bg-color-drop.svg")});
}
.pix-note-icon-button-color::before {
  -webkit-mask-image: url(${pixAsset("icons/ui/button-color-outline.svg")});
          mask-image: url(${pixAsset("icons/ui/button-color-outline.svg")});
}
.pix-note-icon-button-color::after {
  -webkit-mask-image: url(${pixAsset("icons/ui/button-color-drop.svg")});
          mask-image: url(${pixAsset("icons/ui/button-color-drop.svg")});
}
.pix-note-icon-line-color::before {
  -webkit-mask-image: url(${pixAsset("icons/ui/line-color-outline.svg")});
          mask-image: url(${pixAsset("icons/ui/line-color-outline.svg")});
}
.pix-note-icon-line-color::after {
  -webkit-mask-image: url(${pixAsset("icons/ui/line-color-drop.svg")});
          mask-image: url(${pixAsset("icons/ui/line-color-drop.svg")});
}
.pix-note-icon-separator {
  -webkit-mask-image: url(${pixAsset("icons/ui/separator.svg")});
          mask-image: url(${pixAsset("icons/ui/separator.svg")});
}
.pix-note-icon-code {
  -webkit-mask-image: url(${pixAsset("icons/ui/code.svg")});
          mask-image: url(${pixAsset("icons/ui/code.svg")});
}
.pix-note-icon-list-dot {
  -webkit-mask-image: url(${pixAsset("icons/ui/list-dot.svg")});
          mask-image: url(${pixAsset("icons/ui/list-dot.svg")});
}
.pix-note-icon-list-number {
  -webkit-mask-image: url(${pixAsset("icons/ui/list-number.svg")});
          mask-image: url(${pixAsset("icons/ui/list-number.svg")});
}
.pix-note-icon-link {
  -webkit-mask-image: url(${pixAsset("icons/ui/link.svg")});
          mask-image: url(${pixAsset("icons/ui/link.svg")});
}
...
.pix-note-icon-icon-insert {
  -webkit-mask-image: url(${pixAsset("icons/ui/icon-insert.svg")});
          mask-image: url(${pixAsset("icons/ui/icon-insert.svg")});
}

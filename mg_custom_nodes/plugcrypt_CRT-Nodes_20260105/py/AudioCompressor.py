...
class AudioCompressor:
    ...
    def process(self, audio=None, threshold_db=-20.0, ratio=4.0, attack_ms=5.0, release_ms=100.0, 
                warmth=0.1, mix_wet=1.0, makeup_gain_db=0.0, match_input_peak="OFF", 
                soft_clipper_toggle="OFF", clipper_threshold=1.0, prompt=None, extra_pnginfo=None, **kwargs):

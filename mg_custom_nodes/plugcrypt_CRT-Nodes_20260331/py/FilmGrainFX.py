    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "grain_amount": (
                    "FLOAT",
                    {"default": 0.333, "min": 0.0, "max": 1.0, "step": 0.01, "display": "slider"},
                ),
                "grain_size": ("FLOAT", {"default": 1.5, "min": 0.5, "max": 8.0, "step": 0.1, "display": "slider"}),
                "grain_intensity": (
                    "FLOAT",
                    {"default": 0.65, "min": 0.0, "max": 1.0, "step": 0.01, "display": "slider"},
                ),
                "grain_density": (
                    "FLOAT",
                    {"default": 10.0, "min": 0.0, "max": 11.0, "step": 0.1, "display": "slider"},
                ),

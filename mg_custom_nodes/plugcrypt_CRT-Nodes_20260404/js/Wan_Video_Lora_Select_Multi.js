...
class WanVideoLoraSelectMultiUI {
    ...
    injectCSS() {
        ...
        s.textContent = `
            ...
            .wan-wrap input,.wan-wrap select,.wan-wrap button,.wan-wrap label,.wan-wrap .wan-row,.wan-wrap .wan-box,.wan-wrap .wan-bar,.wan-wrap .wan-opt,.wan-wrap .wan-add-btn{pointer-events:auto;}

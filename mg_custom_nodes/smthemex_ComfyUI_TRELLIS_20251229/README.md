...
* [flash attention](https://github.com/Dao-AILab/flash-attention/releases/) or [windows/linux](https://github.com/mjun0812/flash-attention-prebuild-wheels) find  wheel,在这里找flash attention的各种版本轮子

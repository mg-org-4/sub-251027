...
- **Nouveaux formats de quantification** : le nœud ne fait plus uniquement du NVFP4. Un menu `quant_format` permet désormais de choisir entre **W4A8_int8**, **NVFP4**, **MXFP8**, **INT8_CONVROT** et **INT4_CONVROT**.
